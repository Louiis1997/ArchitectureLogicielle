...
public class Project implements Entity<ProjectId> {
    ...
    public Project(ProjectId id, Contractor contractor, ArrayList<Tradesman> tradesmen, ArrayList<Job> jobs, ArrayList<Skill> skills, String localisation, HashMap<Job,Integer> billRate, int duration){
